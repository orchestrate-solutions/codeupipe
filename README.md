...
This repo is the built static site for [codeupipe](https://codeupipe.com) — a composable **Payload → Filter → Pipeline** framework. It is a publish target, not the source of truth. The source lives in the private `orchestrate-solutions/cup` repo and is mirrored here on release.
...
- Project site: https://codeupipe.com
